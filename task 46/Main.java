...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Меня зовут: "+gosha.getName() +   ". Имя моей мамы :" +gosha.getMother().getName() +
                ...
                "У меня две бабушки. Моих бабушек зовут : " +gosha.getMother().getMother().getName() + " и " +gosha.getFather().getMother().getName()
                +".  У меня два деда. Моих дедушек зовут : " +gosha.getFather().getFather().getName() + " и " +gosha.getMother().getFather().getName()+".");
    }
}
